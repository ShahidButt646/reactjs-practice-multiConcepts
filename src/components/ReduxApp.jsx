    ...
    <>
      <header className="App-header">
        ...
        <div className="btn-con">
          <button value={1} onClick={props.onAdd}>
            Add 1
          </button>
          <button value={2} onClick={props.onSub}>
            Sub 1
          </button>
          <button value={3} onClick={props.onMul}>
            Mul 2
          </button>
          <button value={4} onClick={props.onDiv}>
            Dev 2
          </button>
        ...
        <ul>
          {props.srR.map((elm) => (
            <li onClick={() => props.onDeleteResult(elm.id)} key={elm.id}>
              {elm.counter}
            </li>
          ))}
        </ul>
